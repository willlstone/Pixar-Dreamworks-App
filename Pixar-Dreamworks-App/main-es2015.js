...
let BioInfoComponent = class BioInfoComponent {
    constructor(tmdb, route) {
        this.tmdb = tmdb;
        this.route = route;
...
BioInfoComponent.ctorParameters = () => [
...
let CastComponent = class CastComponent {
    constructor(tmdb, route) {
        this.tmdb = tmdb;
        this.route = route;
        this.cast = [];
...
let GridBannerComponent = class GridBannerComponent {
...
GridBannerComponent.ctorParameters = () => [
...
let MovieDetailComponent = class MovieDetailComponent {
    constructor(route, tmdbService, location) {
        this.route = route;
...
MovieGridComponent.ctorParameters = () => [
    { type: _tmdb_service__WEBPACK_IMPORTED_MODULE_2__["TmdbService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
...
let SimilarComponent = class SimilarComponent {
    constructor(tmdb, route) {
        this.tmdb = tmdb;
        this.route = route;
        this.isMovie = true;
...
SimilarComponent.ctorParameters = () => [
    { type: _tmdb_service__WEBPACK_IMPORTED_MODULE_2__["TmdbService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
...
let StaredInComponent = class StaredInComponent {
    constructor(tmdb, route) {
        this.tmdb = tmdb;
        this.route = route;
        this.cast = [];
...
StaredInComponent.ctorParameters = () => [
    { type: _tmdb_service__WEBPACK_IMPORTED_MODULE_2__["TmdbService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
...
let StudioComponent = class StudioComponent {
    constructor() {
    }
    ngAfterViewInit() {
        jarallax(document.querySelectorAll('.jarallax'), {
...
let TrailerComponent = class TrailerComponent {
    constructor(tmdb, sanitizer, route) {
        this.tmdb = tmdb;
...
TrailerComponent.ctorParameters = () => [
    { type: _tmdb_service__WEBPACK_IMPORTED_MODULE_2__["TmdbService"] },
